...
export default function Register() {
  ...
  return (
    <div className="flex justify-center bg-white dark:bg-black items-center min-h-screen">
      <div className="w-3/4 max-w-md p-8 bg-white dark:bg-slate-900 shadow-lg rounded-lg">
        ...
        <form onSubmit={handleRegister}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg text-gray-800 dark:text-white "
            />
          </div>
